...
PROMPT_TEMPLATES = {
    "planner_agent": r"""
        ...
        - `get_student_grades(student_name: str, program: str, year_level: int)`: **Retrieves student grades.** You **MUST** use this for any query containing keywords like **'grades', 'GWA', 'performance'**, or questions like 'who is the smartest student'.
...
class AIAnalyst:
    ...
    def find_people(self, name: str = None, role: str = None, program: str = None, year_level: int = None, section: str = None, department: str = None, employment_status: str = None) -> List[dict]:
        ...
        # --- ✨ FIX: INTELLIGENTLY HANDLE ROLE (STRING OR LIST) ---
    ...
    def _load_dynamic_examples(self) -> str:
        ...
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                # --- ✨ FIX: Process the simple list directly ---
    ...
    def _save_dynamic_example(self, query: str, plan: dict):
        ...
        # --- ✨ FIX: Load/save as a simple list ---
        examples_list = []
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                examples_list = json.load(f)
